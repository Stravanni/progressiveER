...
public class php_driver {
    ...
    private static int minimum_prefix = 7;
    ...
    public static void main(String[] args) {
        ...
        ProgressiveSuffixHierarchies sh = new ProgressivePrefixHierarchies(profiles, minimum_prefix, true, false);
        sh.createHierarchy();
        ...
        while (sh.hasNext()) {
            ...
            Comparison next = (Comparison) sh.next();
            if (next != null) {
