 ...
 * @author gap2
 */
public abstract class AbstractExtendedSortedNeighborhoodBlocking extends AbstractSortedNeighborhoodBlocking {

    public AbstractExtendedSortedNeighborhoodBlocking(int w, List<EntityProfile>[] profiles) {
        super(w, "Memory-based Extended Sorted Neighborhood Blocking", profiles);
    }

    public AbstractExtendedSortedNeighborhoodBlocking(int w, String[] entities, String[] index) {
        super(w, "Disk-based Extended Sorted Neighborhood Blocking", entities, index);
    }
