 ...
 * @author gap2
 */
public abstract class NewAbstractCanopies extends AbstractTokenBlocking {
    ...
    public NewAbstractCanopies(String description, List<EntityProfile>[] profiles) {
    ...
    public NewAbstractCanopies(String description, String[] entities, String[] index) {
    ...
    public List<AbstractBlock> buildBlocks() {
        List<AbstractBlock> tokens = super.buildBlocks();
        entityIndex = new EntityIndex(tokens);
        
        noOfBlocks = tokens.size();
        ...
        if (cleanCleanER) {
            ...
            for (AbstractBlock block : tokens) {
