 ...
 * @author gap2
 */
public abstract class NewAbstractCanopyClustering extends NewAbstractCanopies {

    private final double t1;
    private final double t2;

    public NewAbstractCanopyClustering(double w1, double w2, List<EntityProfile>[] profiles) {
        super("In-memory Canopy Clustering With Weights", profiles);
        t1 = w1;
        t2 = w2;
    }
    
    public NewAbstractCanopyClustering(double w1, double w2, String[] entityPaths, String[] index) {
        super("Canopy Clustering With Weights", entityPaths, index);
        t1 = w1;
        t2 = w2;
    }
