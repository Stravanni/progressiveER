...
public class ProgressiveEntropySnBuilder extends AbstractEntropyBlocking implements Constants {

    protected int[] sortedEntityIds;
    protected int numEntities;
    protected int datasetLimit;

    public ProgressiveEntropySnBuilder(int bKeys, ProfileType pType, List<EntityProfile>[] profiles) {
    ...
    public ProgressiveEntropySnBuilder(List<EntityProfile>[] profiles) {
    ...
    public ProgressiveEntropySnBuilder(String description, List<EntityProfile>[] profiles) {
