...
//import java.util.*;
//
//public class SortedNeighborhoodBlocking_builder extends AbstractTokenBlocking implements Constants {
//
...
//    }
//
//    public SortedNeighborhoodBlocking_builder(String description, List<EntityProfile>[] profiles) {
...
//    }
//
//    public SortedNeighborhoodBlocking_builder(String description, String[] entities, String[] index) {
...
//
//        return Converter.convertCollectionToArray(sortedEntityIds);//sortedEntityIds.toArray(new Integer[sortedEntityIds.size()]);
//    }
//
