...
//
//        int[] counters_neighbor_cooccurrence = new int[noOfEntities];
//        for (int entityId : sortedEntities) {
//            counters_neighbor_cooccurrence[entityId]++;
//        }
//
...
//            entityPositions[i] = new PositionInfo[counters_neighbor_cooccurrence[i]];
//            counters_neighbor_cooccurrence[i] = 0;
//        }
//
//        //build inverted index
//        for (int i = 0; i < sortedEntities.length; i++) {
//            int entityId = sortedEntities[i];
//            entityPositions[entityId][counters_neighbor_cooccurrence[entityId]++] = new PositionInfo(entityId, i);
//        }
//    }
//
