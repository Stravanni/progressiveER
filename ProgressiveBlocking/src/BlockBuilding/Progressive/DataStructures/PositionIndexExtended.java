 ...
 * @author giovanni
 */
public class PositionIndexExtended implements Serializable {
    ...
    private AbstractSortedNeighborhoodBlocking_builder snb;
    ...
    public PositionIndexExtended(int entities, List<EntityProfile>[] profiles, PIWeightingScheme wScheme) {
        ...
        if (weightingScheme == PIWeightingScheme.MINHASH) {
    ...
    public PositionIndexExtended(int entities, AbstractSortedNeighborhoodBlocking_builder snb, PIWeightingScheme wScheme) {
        noOfEntities = entities;
        weightingScheme = wScheme;
