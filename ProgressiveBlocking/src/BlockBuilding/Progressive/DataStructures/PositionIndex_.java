 ...
 * @author gap2
 */
public class PositionIndex_ implements Serializable {
    ...
    public PositionIndex_(AbstractSortedNeighborhoodBlocking_builder snb, PIWeightingScheme wScheme) {
        this(snb.getNumEntities(), snb.getSortedEntities(), snb.getProfileList(), wScheme);
    }

    public PositionIndex_(int no_of_entities, Integer[] sortedEntities, List<EntityProfile>[] profiles, PIWeightingScheme wScheme) {
