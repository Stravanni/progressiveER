...
public abstract class AbstractSortedNeighborhoodBlocking_builder extends AbstractTokenBlocking implements Constants {
    ...
    public AbstractSortedNeighborhoodBlocking_builder(List<EntityProfile>[] profiles) {
        this("Disk-based Sorted Neighborhood Blocking", profiles);
    }

    public AbstractSortedNeighborhoodBlocking_builder(String description, List<EntityProfile>[] profiles) {
    ...
    public AbstractSortedNeighborhoodBlocking_builder(String[] entities, String[] index) {
        this("Disk-based Sorted Neighborhood Blocking", entities, index);
    }

    public AbstractSortedNeighborhoodBlocking_builder(String description, String[] entities, String[] index) {
