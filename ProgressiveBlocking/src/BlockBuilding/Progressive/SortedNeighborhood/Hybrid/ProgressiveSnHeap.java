 ...
 * similarity
 */
package BlockBuilding.Progressive.SortedNeighborhood.Hybrid;
...
public class ProgressiveSnHeap implements Iterator {
    ...
    //public SortedNeighborhoodBlocking_builder snb;
    public ProgressiveSnBuilder snb;
    protected int[] sortedEntities;

    protected Comparator comparator;
    protected MinMaxPriorityQueue<Comparison> comparison_heap;
    //protected PositionIndexExtended pIndex;
    //protected PositionIndex_basic pIndex;
    protected PositionIndex pIndex;

    protected Set<Comparison> comparisons;

    protected WeightingSchemeSn weightingScheme;
    ...
    public ProgressiveSnHeap(List<EntityProfile>[] profiles, boolean removeRepetedComparisons, int max_win) {
        simpleSN = true;
    ...
    public ProgressiveSnHeap(List<EntityProfile>[] profiles, WeightingSchemeSn wScheme, boolean removeRepetedComparisons, int max_win) {
    ...
    public void buildEntityList(int max_w) {
        ...
        //pIndex = new PositionIndex_basic(snb, weightingScheme);
        pIndex = new PositionIndex(snb.getNumEntities(), snb.getSortedEntities(), weightingScheme, snb.getProfileList());
