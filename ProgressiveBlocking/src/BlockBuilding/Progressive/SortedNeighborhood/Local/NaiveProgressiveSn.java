...
public class NaiveProgressiveSn implements Iterator<Comparison> {
    ...
    /*max window*/
    protected int maxW = 100;

    public NaiveProgressiveSn(List<EntityProfile>[] profiles) {
        this(profiles, false);
    }

    public NaiveProgressiveSn(List<EntityProfile>[] profiles, int max_win) {
        this(profiles, false, max_win);
    }


    public NaiveProgressiveSn(int bk, ProfileType pt, List<EntityProfile>[] profiles) {
        this(profiles, false, false, bk, pt);
    }

    public NaiveProgressiveSn(int bk, ProfileType pt, List<EntityProfile>[] profiles, int max_win) {
        this(profiles, false, false, bk, pt, max_win);
        System.out.println("bk: "+ bk);
    }

    public NaiveProgressiveSn(List<EntityProfile>[] profiles, boolean removeRep, int max_win) {
        this(profiles, removeRep, removeRep, max_win); // when removeRep, it always needs also PositionIndex
    }

    public NaiveProgressiveSn(List<EntityProfile>[] profiles, boolean removeRep) {
        this(profiles, removeRep, removeRep, 100); // when removeRep, it always needs also PositionIndex
    }

    public NaiveProgressiveSn(List<EntityProfile>[] profiles, boolean removeRep, boolean buildPositionIndex, int max_win) {
        this.maxW = max_win;
    ...
    public NaiveProgressiveSn(List<EntityProfile>[] profiles, boolean removeRep, boolean buildPositionIndex, int bk, ProfileType pt) {
        this(profiles, removeRep, buildPositionIndex, bk, pt, 10);
    }
    public NaiveProgressiveSn(List<EntityProfile>[] profiles, boolean removeRep, boolean buildPositionIndex, int bk, ProfileType pt, int max_win) {
        maxW = max_win;
