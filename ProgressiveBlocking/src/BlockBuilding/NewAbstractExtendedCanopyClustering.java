...
public abstract class NewAbstractExtendedCanopyClustering extends NewAbstractCanopies {
    ...
    public NewAbstractExtendedCanopyClustering(int n1, int n2, List<EntityProfile>[] profiles) {
        super("In-memory Canopy Clustering with Nearest Neighbors", profiles);
        this.n1 = n1;
        this.n2 = n2;
        n2NearestEntities = new PriorityQueue<>((int) (2 * n2), new ComparisonWeightComparator());
    }
    
    public NewAbstractExtendedCanopyClustering(int n1, int n2, String[] entityPaths, String[] index) {
        super("In-memory Canopy Clustering with Nearest Neighbors", entityPaths, index);
        this.n1 = n1;
        this.n2 = n2;
        n2NearestEntities = new PriorityQueue<>((int) (2 * n2), new ComparisonWeightComparator());
    }
